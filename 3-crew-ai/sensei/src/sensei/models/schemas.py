...
class ConceptLesson(BaseModel):
    ...
    Returned by the Learning Service after invoking the Teaching Crew.
    The lesson_content is a complete markdown document that includes
    explanations, code examples, and key takeaways - all generated by
    the Knowledge Teacher agent.
    """
    concept_id: str = Field(...)
    concept_title: str = Field(...)
    lesson_content: str = Field(..., description="Complete markdown lesson with code and takeaways")
